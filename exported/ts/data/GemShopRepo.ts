...
export const initGemShopRepo = () => {
    return [    
        ...
        new GemShopItemBase(90, <GemShopItemModel>{
                ...
                "itemDisplayName": "",
                "desc": "FREE! OH YEA!!! Use this on a 4 star card to upgrade it to 5 stars! It works like 4 star cardifiers do, you get to choose which card gets upgraded, no randomness involved!",
                "cost": 1,
                "no": 89,
                "maxPurchases": 1,
                "qty": 0,
        ...
        new GemShopItemBase(93, <GemShopItemModel>{
                ...
                "desc": "20% OFF! A time candy that gives a random amount of time for a nonrandom cost of gems? How inexplicable! @ These candies give up to 500 hours, but on average give 24 hrs.",
                "cost": 315,
                "no": 92,
                "maxPurchases": 27,
                "qty": 1,
