...
export const initNpcRepo = () => {
    return [    
        new NpcBase("TP Pete", <NpcModel>{
                ...
                "quests": {
                    ...
                    "The Rats are to Blame!": <ItemQuestModel>{
                        "Type": QuestType.ItemsAndSpaceRequired,
        ...
        new NpcBase("Builder Bird", <NpcModel>{
                ...
                "dialogue": [
                    <DialogueLineModel>{"Type": QuestType.NoQuest, "DialogueText": "Kacaw!!", "NextIndex": 1, "Name": ""},
                    <DialogueLineModel>{
                        "Type": QuestType.ItemsAndSpaceRequired,
                        "DialogueText": "Kacaw! <br> 'The bird awaits the return of the town gem. They're ready to restore the gem to the portal allowing travel to World 2. They look very stylish in their matching orange hat and scarf.'",
                        "NextIndex": 2,
        ...
        new NpcBase("Constructor Crow", <NpcModel>{
                ...
                "dialogue": [
                    <DialogueLineModel>{"Type": QuestType.NoQuest, "DialogueText": "Squakaw!!", "NextIndex": 1, "Name": ""},
                    <DialogueLineModel>{
                        "Type": QuestType.NoQuest,
        ...
        new NpcBase("Desert Davey", <NpcModel>{
                ...
                "dialogue": [
                    <DialogueLineModel>{"Type": QuestType.NoQuest, "DialogueText": "Yo.", "NextIndex": 1, "Name": ""},
                    <DialogueLineModel>{
                        "Type": QuestType.NoQuest,
        ...
        new NpcBase("Whattso", <NpcModel>{
                ...
                "dialogue": [
                    <DialogueLineModel>{"Type": QuestType.NoQuest, "DialogueText": "O.O", "NextIndex": 1, "Name": ""},
                    <DialogueLineModel>{
                        "Type": QuestType.ItemsAndSpaceRequired,
                        "DialogueText": "O.O <br> QUEST:What are they looking at?",
                        "NextIndex": 3,
                    ...
                    <DialogueLineModel>{"Type": QuestType.NoQuest, "DialogueText": "`-`", "NextIndex": 4, "Name": ""},
                    <DialogueLineModel>{
                        "Type": QuestType.Custom,
                        "DialogueText": "`-` <br> QUEST:They look even sadder now try doing something else...",
                        "NextIndex": 6,
                    ...
                    <DialogueLineModel>{"Type": QuestType.NoQuest, "DialogueText": "O:", "NextIndex": 7, "Name": ""},
                    <DialogueLineModel>{
                        "Type": QuestType.Custom,
                        "DialogueText": "O: <br> QUEST:Thats a good face I think! Do whatever you just did some more!",
                        "NextIndex": 9,
                    ...
                    <DialogueLineModel>{"Type": QuestType.NoQuest, "DialogueText": "C: <br>", "NextIndex": 10, "Name": ""},
                    <DialogueLineModel>{
                        "Type": QuestType.Custom,
                        "DialogueText": "C: <br> QUEST:The whale stares at you. He's too happy. You know what must be done.",
                        "NextIndex": 12,
                    ...
                    <DialogueLineModel>{"Type": QuestType.NoQuest, "DialogueText": "D:", "NextIndex": 12, "Name": ""}
                ]
            }),
        ...
        new NpcBase("Bandit Bob", <NpcModel>{
                ...
                "dialogue": [
                    ...
                    <DialogueLineModel>{"Type": QuestType.NoQuest, "DialogueText": "Huh...", "NextIndex": 17, "Name": ""},
                    <DialogueLineModel>{
                        "Type": QuestType.NoQuest,
        ...
        new NpcBase("Snake Jar", <NpcModel>{
                ...
                "dialogue": [
                    ...
                    <DialogueLineModel>{"Type": QuestType.NoQuest, "DialogueText": "...", "NextIndex": 13, "Name": ""},
                    <DialogueLineModel>{"Type": QuestType.NoQuest, "DialogueText": "... ...", "NextIndex": 14, "Name": ""},
                    <DialogueLineModel>{
                        "Type": QuestType.NoQuest,
                        "DialogueText": "... ... ...",
                        "NextIndex": 15,
        ...
        new NpcBase("Centurion", <NpcModel>{
                ...
                "dialogue": [
                    ...
                    <DialogueLineModel>{"Type": QuestType.NoQuest, "DialogueText": "Filler", "NextIndex": 22, "Name": ""},
                    <DialogueLineModel>{
                        "Type": QuestType.LevelReq,
                    ...
                    <DialogueLineModel>{"Type": QuestType.NoQuest, "DialogueText": "Filler", "NextIndex": 23, "Name": ""}
                ]
            }),
        ...
        new NpcBase("Lonely Hunter", <NpcModel>{
                ...
                "dialogue": [
                    <DialogueLineModel>{"Type": QuestType.NoQuest, "DialogueText": "Ughh...", "NextIndex": 1, "Name": ""},
                    <DialogueLineModel>{
                        "Type": QuestType.NoQuest,
        ...
        new NpcBase("Walupiggy", <NpcModel>{
                ...
                "dialogue": [
                    <DialogueLineModel>{"Type": QuestType.NoQuest, "DialogueText": "WAAAH!!!", "NextIndex": 1, "Name": ""},
                    <DialogueLineModel>{
                        "Type": QuestType.Custom,
                        "DialogueText": "WAHAHAHAHA! <br> QUEST:Complete the 1st Treasure Hunt! You need to go to the Legends of IdleOn youtube channel to find the clues to follow to complete this!",
                        "NextIndex": 3,
                    ...
                    <DialogueLineModel>{"Type": QuestType.NoQuest, "DialogueText": "WAH?", "NextIndex": 1, "Name": ""},
                    <DialogueLineModel>{
                        "Type": QuestType.NoQuest,
                    ...
                    <DialogueLineModel>{"Type": QuestType.NoQuest, "DialogueText": "WAH?", "NextIndex": 4, "Name": ""},
                    <DialogueLineModel>{
                        "Type": QuestType.NoQuest,
                    ...
                    <DialogueLineModel>{"Type": QuestType.NoQuest, "DialogueText": "WAH?", "NextIndex": 7, "Name": ""},
                    <DialogueLineModel>{
                        "Type": QuestType.NoQuest,
                        "DialogueText": "WAOOO!! YEHEHEHE!!",
                        "NextIndex": 10,
                    ...
                    <DialogueLineModel>{"Type": QuestType.NoQuest, "DialogueText": "WAH?", "NextIndex": 10, "Name": ""},
                    <DialogueLineModel>{
                        "Type": QuestType.NoQuest,
                        "DialogueText": "WAOOO!! YEHEHEHE!!",
                        "NextIndex": 12,
