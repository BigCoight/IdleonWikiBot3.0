...
export const initGemShopRepo = () => {
    return [    
        ...
        new GemShopItemBase(89, <GemShopItemModel>{
                ...
                "mtxName": "Mob Respawn Keychain",
                "itemDisplayName": "Negative 7 Chain",
        ...
        new GemShopItemBase(91, <GemShopItemModel>{
                ...
                "itemDisplayName": "Hat Premiumifier",
                "desc": "Holy heck, a gemshop freebie! Turns any normal hat into a premium hat! This is the same item buyable in the Cosmetics section, but I'm putting it here also since it works great with the Premium Hat Swapper Stone!",
                "cost": 1,
                "no": 90,
                "maxPurchases": 1,
                "qty": 1,
