...
export const initGemShopRepo = () => {
    return [    
        ...
        new GemShopItemBase(90, <GemShopItemModel>{
                ...
                "itemDisplayName": "",
                "desc": "10% OFF, usually costs 480! Use this on a 4 star card to upgrade it to 5 stars! It works like 4 star cardifiers, you get to choose which card gets upgraded, no randomness involved!",
                "cost": 430,
                "no": 89,
                "maxPurchases": 7,
                "qty": 0,
