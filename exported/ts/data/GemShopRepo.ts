...
export const initGemShopRepo = () => {
    return [    
        ...
        new GemShopItemBase(64, <GemShopItemModel>{
                ...
                "desc": "Each purchase gives +10 daily teleports every day, forever. You can use these on the Map Screen. You can be gone for up to 4 days and claim them all upon your return!",
                "cost": 200,
                "no": 71,
                "maxPurchases": 7,
                "qty": 0,
        ...
        new GemShopItemBase(88, <GemShopItemModel>{
                "name": "EquipmentRings33",
                "itemName": "World 2 Killer Ring",
                "desc": "Helps you reach world 3 faster! When Equipped, gives +30% Kills so you can open portals way faster, but ONLY IN WORLD 2.",
                "cost": 550,
                "no": 87,
                "maxPurchases": 1,
                "qty": 1,
        ...
        new GemShopItemBase(89, <GemShopItemModel>{
                ...
                "itemName": "World 3 Killer Ring",
                "desc": "Helps you reach world 4 faster! When Equipped, gives +30% Kills for things like opening portals and Deathnote, but ONLY IN WORLD 3.",
                "cost": 700,
                "no": 88,
                "maxPurchases": 1,
                "qty": 1,
        ...
        new GemShopItemBase(90, <GemShopItemModel>{
                ...
                "itemName": "World 4 Killer Ring",
                "desc": "Helps you reach world 5 faster! When Equipped, gives +30% Kills for things like opening portals and Deathnote, but ONLY IN WORLD 4.",
                "cost": 900,
                "no": 89,
                "maxPurchases": 1,
                "qty": 1,
        ...
        new GemShopItemBase(91, <GemShopItemModel>{
                ...
                "itemName": "Crescent Moon Exp Pendant",
                "desc": "Gives +35% EXP gain when killing monsters! Level up more, get more talent points... go harder, get better, go faster, get stronger! Also gives +5% monster respawn cuz why not lol",
                "cost": 850,
                "no": 90,
                "maxPurchases": 1,
                "qty": 1,
