...
export const initGemShopRepo = () => {
    return [    
        ...
        new GemShopItemBase(89, <GemShopItemModel>{
                ...
                "desc": "30% OFF SALE!!! This necklace equipment comes with a 1.30X Damage Multi bonus, and +20% Mob Respawn bonus!",
                "cost": 609,
                "no": 88,
                "maxPurchases": 2,
                "qty": 1,
        ...
        new GemShopItemBase(92, <GemShopItemModel>{
                "section": "Limited Specials",
                "name": "RibbonBig4",
                "mtxName": "Low Tier Ribbon",
                "itemDisplayName": "",
                "desc": "Gives you a random ribbon for your Ribbon Shelf, found at the Meals Menu in World 4! 40% chance for Tier 4, 30% chance for Tier 5, 20% for Tier 6, 7% for Tier 7, and 3% for Tier 8!",
                "cost": 330,
                "no": 91,
                "maxPurchases": 20,
                "qty": 0,
        ...
        new GemShopItemBase(93, <GemShopItemModel>{
                "section": "Limited Specials",
                "name": "RibbonBig9",
                "mtxName": "High Tier Ribbon",
                "itemDisplayName": "",
                "desc": "Gives you a random ribbon for your Ribbon Shelf, found at the Meals Menu in World 4! 40% chance for Tier 7, 30% chance for Tier 8, 20% for Tier 9, 7% for Tier 10, and 3% for Tier 11!",
                "cost": 460,
                "no": 92,
                "maxPurchases": 20,
                "qty": 0,
