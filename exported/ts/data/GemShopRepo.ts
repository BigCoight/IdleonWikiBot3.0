...
export const initGemShopRepo = () => {
    return [    
        ...
        new GemShopItemBase(90, <GemShopItemModel>{
                ...
                "itemDisplayName": "",
                "desc": "20% OFF NORMAL PRICE! Use this on a 4 star card to upgrade it to 5 stars! It works like 4 star cardifiers do, you get to choose which card gets upgraded, no randomness involved!",
                "cost": 390,
                "no": 89,
                "maxPurchases": 10,
                "qty": 0,
        ...
        new GemShopItemBase(94, <GemShopItemModel>{
                ...
                "desc": "20% OFF NORMAL PRICE! A time candy that gives a random amount of time! @ These candies give up to 500 hours, but on average give 24 hrs.",
                "cost": 325,
                "no": 93,
                "maxPurchases": 18,
                "qty": 1,
        ...
        new GemShopItemBase(95, <GemShopItemModel>{
                ...
                "mtxName": "4 Star Cardifier",
                "itemDisplayName": "Infinite Forge",
                "desc": "99.99999% OFF NORMAL PRICE! Use this on a 3 star card to upgrade it to 4 stars instantly! No randomness involved! You'll see where to use these by clicking a card in game.",
                "cost": 1,
                "no": 94,
                "maxPurchases": 2,
                "qty": 0,
