...
class IdleonModel(BaseModel):
	...
	def intToWiki(self) -> Dict[str, Union[Callable, str]]:
		"""
		Should return a dictionary that either poitns to a function to return the value wanted OR to the attribute name.
		For example {"health": "health"} if the IdleonModel has self.health as a parameter.
