...
export const initPostOfficeRepo = () => {
    return [    
        new PostOfficeBase("Simple Shippin", <PostOfficeModel>{
                "orders": [
                    <PartModel>{"item": "Copper", "base": 150, "increment": 1},
                    <PartModel>{"item": "Iron", "base": 150, "increment": 1},
                    <PartModel>{"item": "CopperBar", "base": 50, "increment": 1},
                    <PartModel>{"item": "OakTree", "base": 200, "increment": 1},
                    <PartModel>{"item": "BirchTree", "base": 100, "increment": 1},
                    <PartModel>{"item": "JungleTree", "base": 80, "increment": 1},
                    <PartModel>{"item": "Fish1", "base": 120, "increment": 1},
                    <PartModel>{"item": "Bug1", "base": 120, "increment": 1},
                    <PartModel>{"item": "Fish2", "base": 100, "increment": 1},
                    <PartModel>{"item": "Bug2", "base": 100, "increment": 1},
                    <PartModel>{"item": "IronBar", "base": 50, "increment": 1},
                    <PartModel>{"item": "CraftMat1", "base": 100, "increment": 1},
                    <PartModel>{"item": "CraftMat5", "base": 40, "increment": 1},
                    <PartModel>{"item": "Gold", "base": 100, "increment": 1},
                    <PartModel>{"item": "GoldBar", "base": 25, "increment": 1},
                    <PartModel>{"item": "ToiletTree", "base": 125, "increment": 1},
                    <PartModel>{"item": "Fish3", "base": 70, "increment": 1},
                    <PartModel>{"item": "Bug3", "base": 90, "increment": 1},
                    <PartModel>{"item": "CraftMat6", "base": 25, "increment": 1},
                    <PartModel>{"item": "PalmTree", "base": 110, "increment": 1},
                    <PartModel>{"item": "Fish4", "base": 40, "increment": 1},
                    <PartModel>{"item": "StumpTree", "base": 100, "increment": 1},
                    <PartModel>{"item": "Bug4", "base": 65, "increment": 1}
                ],
        ...
        new PostOfficeBase("Plan-it Express", <PostOfficeModel>{
                "orders": [
                    <PartModel>{"item": "EquipmentHats1", "base": 1, "increment": 1},
                    <PartModel>{"item": "TestObj1", "base": 1, "increment": 1},
                    <PartModel>{"item": "EquipmentShoes9", "base": 1, "increment": 1},
                    <PartModel>{"item": "EquipmentShoes1", "base": 1, "increment": 1},
                    <PartModel>{"item": "EquipmentShoes15", "base": 1, "increment": 1},
                    <PartModel>{"item": "EquipmentHats15", "base": 1, "increment": 1},
                    <PartModel>{"item": "EquipmentShirts11", "base": 1, "increment": 1},
                    <PartModel>{"item": "EquipmentHats16", "base": 1, "increment": 1},
                    <PartModel>{"item": "EquipmentShirts2", "base": 1, "increment": 1},
        ...
        new PostOfficeBase("Dudes Next Door", <PostOfficeModel>{
                "orders": [
                    <PartModel>{"item": "Grasslands1", "base": 125, "increment": 1},
                    <PartModel>{"item": "Grasslands2", "base": 120, "increment": 1},
                    <PartModel>{"item": "Grasslands3", "base": 115, "increment": 1},
                    <PartModel>{"item": "Jungle1", "base": 110, "increment": 1},
                    <PartModel>{"item": "Jungle2", "base": 105, "increment": 1},
                    <PartModel>{"item": "Jungle3", "base": 100, "increment": 1},
                    <PartModel>{"item": "Forest1", "base": 100, "increment": 1},
                    <PartModel>{"item": "Forest2", "base": 90, "increment": 1},
                    <PartModel>{"item": "Forest3", "base": 90, "increment": 1},
                    <PartModel>{"item": "DesertA1", "base": 100, "increment": 1},
                    <PartModel>{"item": "Sewers1", "base": 100, "increment": 1},
                    <PartModel>{"item": "DesertA2", "base": 95, "increment": 1},
                    <PartModel>{"item": "TreeInterior1", "base": 80, "increment": 1},
                    <PartModel>{"item": "DesertA3", "base": 150, "increment": 1},
                    <PartModel>{"item": "Sewers2", "base": 100, "increment": 1},
                    <PartModel>{"item": "TreeInterior2", "base": 70, "increment": 1},
                    <PartModel>{"item": "Quest17", "base": 2, "increment": 1},
                    <PartModel>{"item": "DesertB1", "base": 100, "increment": 1},
                    <PartModel>{"item": "DesertB2", "base": 100, "increment": 1},
                    <PartModel>{"item": "DesertB3", "base": 80, "increment": 1},
                    <PartModel>{"item": "DesertB4", "base": 80, "increment": 1},
                    <PartModel>{"item": "DesertC1", "base": 80, "increment": 1},
                    <PartModel>{"item": "DesertC2", "base": 80, "increment": 1},
                    <PartModel>{"item": "DesertC3", "base": 80, "increment": 1},
                    <PartModel>{"item": "DesertC4", "base": 80, "increment": 1},
                    <PartModel>{"item": "EfauntDrop1", "base": 2, "increment": 1}
                ],
        ...
        new PostOfficeBase("Down Undelivery", <PostOfficeModel>{
                "orders": [
                    ...
                    <PartModel>{"item": "DesertA1b", "base": 1, "increment": 1},
                    <PartModel>{"item": "DesertC2b", "base": 5, "increment": 1},
                    <PartModel>{"item": "TreeInterior1b", "base": 1, "increment": 1},
                    <PartModel>{"item": "Sewers1b", "base": 1, "increment": 1},
                    <PartModel>{"item": "SnowA2a", "base": 1, "increment": 1},
                    <PartModel>{"item": "SnowB2a", "base": 1, "increment": 1},
                    <PartModel>{"item": "SnowC4a", "base": 1, "increment": 1}
                ],
        ...
        new PostOfficeBase("Alpine Suppliers", <PostOfficeModel>{
                "orders": [
                    <PartModel>{"item": "SnowA1", "base": 250, "increment": 1},
                    <PartModel>{"item": "SnowA2", "base": 230, "increment": 1},
                    <PartModel>{"item": "SnowA3", "base": 220, "increment": 1},
                    <PartModel>{"item": "SnowB1", "base": 210, "increment": 1},
                    <PartModel>{"item": "SnowB2", "base": 200, "increment": 1},
                    <PartModel>{"item": "SnowB5", "base": 180, "increment": 1},
                    <PartModel>{"item": "SnowB3", "base": 170, "increment": 1},
                    <PartModel>{"item": "SnowB4", "base": 160, "increment": 1},
                    <PartModel>{"item": "SnowC1", "base": 150, "increment": 1},
                    <PartModel>{"item": "SnowC2", "base": 145, "increment": 1},
                    <PartModel>{"item": "SnowC3", "base": 140, "increment": 1},
                    <PartModel>{"item": "SnowC4", "base": 135, "increment": 1},
                    <PartModel>{"item": "SnowA4", "base": 100, "increment": 1},
                    <PartModel>{"item": "SnowC5", "base": 50, "increment": 1}
                ],
        ...
        new PostOfficeBase("Cosmic Carrier", <PostOfficeModel>{
                "orders": [
                    <PartModel>{"item": "GalaxyA1", "base": 500, "increment": 1},
                    <PartModel>{"item": "GalaxyA3", "base": 500, "increment": 1},
                    <PartModel>{"item": "GalaxyA2b", "base": 1, "increment": 1},
                    <PartModel>{"item": "AlienTree", "base": 300, "increment": 1},
                    <PartModel>{"item": "Fish5", "base": 250, "increment": 1},
                    <PartModel>{"item": "GalaxyB1", "base": 1000, "increment": 1},
                    <PartModel>{"item": "Bug7", "base": 300, "increment": 1},
                    <PartModel>{"item": "GalaxyB3", "base": 300, "increment": 1},
                    <PartModel>{"item": "GalaxyB4", "base": 300, "increment": 1},
                    <PartModel>{"item": "Lustre", "base": 300, "increment": 1},
                    <PartModel>{"item": "GalaxyC1", "base": 300, "increment": 1},
                    <PartModel>{"item": "Tree8", "base": 300, "increment": 1},
                    <PartModel>{"item": "GalaxyC1b", "base": 1, "increment": 1},
                    <PartModel>{"item": "GalaxyC4", "base": 300, "increment": 1},
                    <PartModel>{"item": "Starfire", "base": 100, "increment": 1},
                    <PartModel>{"item": "Bug8", "base": 300, "increment": 1}
                ],
